...
class StarfinderCharacterObject:
   ...
   def can_add_skillpoint_at_level(self, skillName, lvl):
      ...
      print(self.skillRanksByLevel[skillName])
      if self.get_remaining_skillpoints_at_level(lvl) > 0 and skillRanks < lvl:
         print(self.get_remaining_skillpoints_at_level(lvl),skillRanks,lvl)
         return True
      return False
   ...
   def get_total_skillpoints_at_level(self,lvl):
      if (lvl == None):
         lvl = self.level
      return self._getNumericSumOfEffectsOnlyAtLevel(lvl,['skillpoints'])
   ...
   @property
   def strScore(self):
      return self._statGet(self.strBaseScore+self._strScore,'strbonus')
   @strScore.setter
   def strScore(self,value):
      self._strScore = value
   @property
   def dexScore(self):
      return self._statGet(self.dexBaseScore+self._dexScore,'dexbonus')
   @dexScore.setter
   def dexScore(self,value):
      self._dexScore = value
   @property
   def conScore(self):
      return self._statGet(self.conBaseScore+self._conScore,'conbonus')
   @conScore.setter
   def conScore(self,value):
      self._conScore = value
   @property
   def intScore(self):
      return self._statGet(self.intBaseScore+self._intScore,'intbonus')
   @intScore.setter
   def intScore(self,value):
      self._intScore = value
   @property
   def wisScore(self):
      return self._statGet(self.wisBaseScore+self._wisScore,'wisbonus')
   @wisScore.setter
   def wisScore(self,value):
      self._wisScore = value
   @property
   def chaScore(self):
      return self._statGet(self.chaBaseScore+self._chaScore,'chabonus')
   @chaScore.setter
   ...
   def staminaPointsTotal(self):
      return self._getNumericSumOfEffectsAtLevel(self.setLevel,['staminabonus'])
   ...
   @property
   def speed(self):
      return str(self._speed) + ' ft.'

   @property
   def initiativeMisc(self):
      return self._getNumericSumOfEffectsAtLevel(self.setLevel,['initiativebonus'])
   ...
   def meleeAttackMiscMod(self):
      return self._getNumericSumOfEffectsAtLevel(self.setLevel,['meleeattackbonus','attackbonus'])
   @property
   ...
   def rangedAttackMiscMod(self):
      return self._getNumericSumOfEffectsAtLevel(self.setLevel,['rangedattackbonus','attackbonus'])
   @property
   ...
   def thrownAttackMiscMod(self):
      return self._getNumericSumOfEffectsAtLevel(self.setLevel,['thrownattackbonus','attackbonus'])
   @property
